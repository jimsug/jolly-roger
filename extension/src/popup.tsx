...
const Popup = () => {
  ...
  const form = (
    <Form onSubmit={addPuzzle}>
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-title`}>
          Title
        </Form.Label>
        <Col xs={9}>
          <Form.Control
            id={`${idPrefix}-jr-title`}
            type="text"
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-url`}>
          URL
        </Form.Label>
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-tags`}>
          Tags
        </Form.Label>
        <Col xs={9}>
          <Creatable
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-doc-type`}>
          Document type{" "}
          <OverlayTrigger
            overlay={
              <Tooltip>
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label
          column
          xs={3}
          htmlFor={`${idPrefix}-jr-expected-answer-count`}
        >
          Expected # of answers
        </Form.Label>
        <Col xs={9}>
          <Form.Control
            id={`${idPrefix}-jr-expected-answer-count`}
            type="number"
            disabled={disableForm}
  ...
  const bulkAddForm = (
    <Form onSubmit={onBulkAdd}>
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-bulk-tags`}>
          Tags
        </Form.Label>
        <Col xs={9}>
          <Creatable
            id={`${idPrefix}-jr-bulk-tags`}
            options={selectOptions}
            isMulti
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-bulk-doc-type`}>
          Document type
        </Form.Label>
        <Col xs={9}>
          <Form.Select
      ...
      <Form.Group as={Row} className="mb-3">
        <Form.Label
          column
          xs={3}
          htmlFor={`${idPrefix}-jr-bulk-expected-answer-count`}
        >
          Expected # of answers
        </Form.Label>
        <Col xs={9}>
          <Form.Control
            id={`${idPrefix}-jr-bulk-expected-answer-count`}
            type="number"
            disabled={bulkSaving}
      ...
      <Form.Group className="mb-3">
        <Form.Label htmlFor={`${idPrefix}-jr-bulk-filter`}>
          Filter links
        </Form.Label>
        <Form.Control
          id={`${idPrefix}-jr-bulk-filter`}
          type="text"
      ...
      {bulkStatus && (
        ...
        >
          ...
          {bulkStatus.errors.map((err, i) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: errors are simple strings
            <div key={i}>
              <small>{err}</small>
            </div>
          ))}
  ...
  const contents =
    jollyRogerInstance !== "" && apiKey !== "" ? (
      <>
        <Form.Group as={Row} className="mb-3">
          <Form.Label column xs={3} htmlFor={`${idPrefix}-jr-hunt`}>
            Hunt
          </Form.Label>
          <Col xs={9}>
            <Form.Select
