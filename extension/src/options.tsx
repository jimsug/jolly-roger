...
const Options = () => {
  ...
  const form = (
    <Form onSubmit={saveOptions}>
      <Form.Group>
        <Form.Label htmlFor={`${idPrefix}-jr-instance`}>
          Jolly Roger instance
        </Form.Label>
        <Form.Control
          id={`${idPrefix}-jr-instance`}
      ...
      <Form.Group className="mt-3">
        <Form.Label htmlFor={`${idPrefix}-jr-api-key`}>API key</Form.Label>
        <Form.Control
          id={`${idPrefix}-jr-api-key`}
